...
struct at91_mmc_data {
	...
	unsigned	wire4:1;	/* (SD/MMC) supports DAT0..DAT3 */
...
// Start
extern void __init urp2_add_ext_uart(void);
//  End
...
struct at91_tsadcc_data {
	unsigned int	prescale;	/* prescale value */
	unsigned int	startup;	/* startup time value */
	unsigned int    adc_clock;
};
extern void __init at91_add_device_tsadcc(/*void*/struct at91_tsadcc_data *data);
